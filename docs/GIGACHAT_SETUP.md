...
|--------|----------|----------|-------------------|
| `GigaChat-2` | Базовая модель | 8K токенов | Общие задачи |
| `GigaChat-2-Plus` | Расширенная | 32K токенов | Сложные задачи |
| `GigaChat-2-Pro` | Профессиональная | 32K токенов | Продакшен |
